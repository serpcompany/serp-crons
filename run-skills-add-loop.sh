...
Runs:
  npx skills add https://github.com/serpdownloaders/skills --skills skool-video-downloader vimeo-video-downloader loom-video-downloader onlyfans-video-downloader -y
